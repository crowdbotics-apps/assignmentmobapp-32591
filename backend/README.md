...
## Project Structure
    ...
    ├── assignmentmobapp_32591  # Django project configurations
...
1. Clone this repo and `cd assignmentmobapp_32591`
...
2. Clone this repo and `cd assignmentmobapp_32591`
